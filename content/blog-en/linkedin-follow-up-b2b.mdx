...
For the broader framework on how to build the social selling system that makes follow-up feel natural, read the [LinkedIn Social Selling Guide](/blog/linkedin-social-selling-guide). For the prospecting side — how to find and start conversations in the first place — see the [LinkedIn Prospecting Guide](/blog/linkedin-prospecting-guide).
