  ...
  return (
    <html lang="pt-BR" className={barlow.variable} suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-cream text-chattie-black">
        ...
        {/* Microsoft Clarity — behavioral analytics + Bing WMT integration */}
        {process.env.NEXT_PUBLIC_CLARITY_ID && (
          <Script id="ms-clarity" strategy="afterInteractive">{`(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y)})(window,document,"clarity","script","${process.env.NEXT_PUBLIC_CLARITY_ID}");`}</Script>
        )}
        {/* Endorsely affiliate tracking */}
        <Script
          src="https://assets.endorsely.com/endorsely.js"
          data-endorsely="6b815f42-8068-4f03-b46a-e1b22a564680"
          strategy="afterInteractive"
        />
      </body>
    </html>
