...
const FAQ_DATA: Record<string, FaqItem[]> = {
  ...
  'foto-de-perfil-linkedin-profissional': [
    { q: 'A foto de perfil LinkedIn realmente impacta a taxa de aceitação de conexões?', a: 'Sim, diretamente. Perfis com foto recebem até 21 vezes mais visualizações do que perfis sem foto. Para prospecção ativa B2B, onde você envia convites em escala, uma foto inadequada ou ausente reduz significativamente a taxa de aceitação — independentemente da qualidade da mensagem de conexão.' },
    { q: 'Posso usar uma foto gerada por IA no LinkedIn para prospecção B2B?', a: 'Tecnicamente sim, mas não é recomendado para vendas B2B de médio e alto ticket. Prospects experientes percebem quando a foto foi gerada artificialmente — e isso pode gerar desconfiança exatamente no momento em que você precisa de credibilidade máxima. Ferramentas de IA são úteis para melhorar uma foto real, não para substituí-la.' },
    { q: 'Com que frequência devo atualizar a foto de perfil no LinkedIn?', a: 'Atualize sempre que sua aparência mudar significativamente ou a cada 2–3 anos, o que vier primeiro. O critério prático: se um prospect que aceitou sua conexão fizer uma videochamada com você e notar diferença significativa, está na hora de atualizar.' },
    { q: 'Qual o tamanho ideal para foto de perfil no LinkedIn?', a: 'O LinkedIn recomenda imagens de 400x400 pixels no mínimo, com tamanho de arquivo de até 8 MB. Formatos aceitos: JPG, PNG, GIF. Uma imagem de alta resolução garante qualidade em todos os contextos — thumbnail no feed, perfil completo e mensagens.' },
  ],
  'prospeccao-ativa-vs-inbound-linkedin-b2b': [
    { q: 'Qual é a melhor estratégia para começar: prospecção ativa ou inbound?', a: 'A maioria dos founders B2B brasileiros deve começar com prospecção ativa, pois gera pipeline imediato e previsível. Inbound é mais eficiente a longo prazo, mas leva meses para produzir volume consistente. O ideal é iniciar com ativa e progressivamente integrar inbound conforme a autoridade cresce.' },
    { q: 'Quanto tempo leva para o inbound no LinkedIn gerar resultados?', a: 'O inbound no LinkedIn requer 3 a 6 meses de conteúdo consistente antes de gerar volume relevante de leads. Durante esse período, a prospecção ativa deve manter o pipeline abastecido enquanto você constrói posicionamento e reputação junto ao seu ICP.' },
    { q: 'Qual é a diferença entre um SDR em prospecção ativa e um perfil de inbound?', a: 'Um SDR em prospecção ativa busca, aborda e qualifica prospects ativamente — ele vai atrás. No inbound, o profissional cria conteúdo e posicionamento para atrair — o prospect vem até ele. O SDR reduz custo operacional imediato; inbound reduz custo de aquisição a longo prazo.' },
    { q: 'É possível combinar prospecção ativa e inbound no LinkedIn simultaneamente?', a: 'Sim, e essa é a estratégia mais eficaz para B2B. Enquanto você constrói autoridade com conteúdo (inbound), execute prospecção ativa para manter pipeline abastecido. O ideal é usar ferramentas que escalam a ativa sem perder personalização durante essa transição.' },
  ],
