...
export function ShareButtons({ url, title, lang = 'pt-BR' }: ShareButtonsProps) {
  ...
  const eyebrow = isPtBr ? 'Compartilhar artigo' : 'Share this article'
  const headline = isPtBr
        ...
        {shares.map((s) => (
          <a
            ...
            style={{
              ...
              color: s.textColor,
              border: '2px solid #000',
              padding: s.primary ? '0.65rem 1.4rem' : '0.65rem 1rem',
              fontSize: s.primary ? '0.9rem' : '0.85rem',
              fontFamily: "'Sherika', sans-serif",
              fontWeight: 800,
              textDecoration: 'none',
